...
class sukerStockInfoFrame(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.label_Numberofshares = wx.StaticText(self, wx.ID_ANY, "Number of shares", style=wx.ALIGN_CENTER)
        ...
        self.label_profit = wx.StaticText(self, wx.ID_ANY, "profit")
    ...
    def __do_layout(self):
        ...
        self.sizer_9.Add(sizer_2, 13, wx.EXPAND, 0)
