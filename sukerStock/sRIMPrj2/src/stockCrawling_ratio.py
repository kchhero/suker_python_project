...
class stockCrawlingRatio :
    ...
    yearList_2024=["2021/12", "2022/12", "2023/12", "2024/12"]
    yearList_2025=["2022/12", "2023/12", "2024/12", "2025/03"]
    yearCLE_2024="2024/12"
    yearCLE_2025="2025/03"
    
    yearList = yearList_2024
    yearCLE = yearCLE_2024
